...
import static com.iohao.cookbook.common.FlowContextCallCmd.*;

@Slf4j
public class FlowContextCallRegion extends AbstractInputCommandRegion {
    @Override
    public void initInputCommand() {
        this.setCmd(FlowContextCallCmd.cmd, "FlowContextCall");
