 ...
 * @since 25.1
 */
public final class GameManagerLogicServer implements LogicServer, NetServerSettingAware {
    @Override
    ...
    public void settingServerBuilder(ServerBuilder builder) {
        builder.setName("GameManagerLogicServer");
    }

    @Override
    public void setNetServerSetting(NetServerSetting setting) {
        GameManagerKit.setting = setting;
    }
}
