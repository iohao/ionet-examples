 ...
 * @since 25.3
 */
public final class AuthorLogicServer implements LogicServer {

    @Override
    public void settingBarSkeletonBuilder(BarSkeletonBuilder builder) {
        MyLogicServerKit.defaultSetting(builder, AuthorAction.class);
    }

    @Override
    public void settingServerBuilder(ServerBuilder builder) {
        builder.setName("author-LogicServer");
    }
}
